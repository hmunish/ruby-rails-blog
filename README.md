...
**[ROR Blog App]** is a blog app made using Ruby on Rails framework which follows MVC pattern to develop application.
...
```sh
  cd my-folder
  git clone https://github.com/hmunish/ruby-rails-blog.git
```
...
I would like to thank Microverse for providing linters configuration files & steps to configure Rails application.
